...
(function () {
  AOS.init();
  document.addEventListener('aos:in:super-duper', function (_ref) {
    var detail = _ref.detail;
    new TypeIt(detail.querySelector('.s-title__title'), {
      speed: 30,
      cursor: false,
      nextStringDelay: 0
    }).go();
  ...
  document.querySelectorAll('.mySwiper').forEach(function (el) {
    ...
    swiper.on('lazyImageReady', function (e) {
      AOS.refresh();
      rellax.refresh();
    });
  });
  ...
  document.querySelectorAll('a[href^="#"]').forEach(function (anchor) {
    anchor.addEventListener('click', function (e) {
      ...
      var _iterator = _createForOfIteratorHelper(document.querySelectorAll('.lazyload')),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var el = _step.value;
          lazySizes.loader.unveil(el); //console.log(el);
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
      ...
      setTimeout(function () {
        document.querySelector(_this.getAttribute('href')).scrollIntoView({
          behavior: 'smooth'
        });
      }, 500);
    });
  ...
  try {
    var _loop = function _loop() {
      ...
      trigger.onclick = function (e) {
        ...
        if (trigger.hasAttribute('bodyfix')) {
          var body = document.querySelectorAll('body')[0];
          trigger.classList.contains('active') ? body.classList.add('fix') : body.classList.remove('fix');
        }

        var targetClasses = trigger.getAttribute('targets').split(' ');

        var _iterator3 = _createForOfIteratorHelper(targetClasses),
            _step3;

        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var targetClass = _step3.value;
        ...
        document.querySelectorAll('body')[0].style.setProperty('--vh', "".concat(vh, "px"));
      };
    };
  ...
  if (document.querySelector('.footer__overlay')) {
    document.querySelector('.footer__overlay').onclick = function (e) {
      document.querySelector('.footer').classList.remove('active');
      document.querySelector('.footer__trigger').classList.remove('active');
    };
  } //footer overlay end
